...
import static net.dv8tion.yui.config.Configuration.COMMENT_SEPARATOR;
import static net.dv8tion.yui.config.Configuration.NEW_LINE;
import static net.dv8tion.yui.config.Configuration.allowedProperties;

...
package net.dv8tion.yui.config;
...
import static net.dv8tion.yui.config.Property.Type.BOOLEAN;
import static net.dv8tion.yui.config.Property.Type.DOUBLE;
import static net.dv8tion.yui.config.Property.Type.INTEGER;
import static net.dv8tion.yui.config.Property.Type.STRING;
/**
...
//        String basePath = ((File)(FMLInjectionData.data()[6])).getAbsolutePath().replace(File.separatorChar, '/').replace("/.", "");
        ...
        else
        {
            ...
            catch (Throwable e)
            {
                ...
                System.err.printf("An exception occurred while loading config file %s. This file will be renamed to %s " +
                        "and a new config file will be generated.\n", file.getName(), fileBak.getName());
                e.printStackTrace();
